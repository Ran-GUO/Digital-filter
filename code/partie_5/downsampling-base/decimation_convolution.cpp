...
void ConvolutionDecimation::do_horizontal_decimation(uint16_t *dst_ptr, uint16_t *src_ptr,
                           uint dst_width, uint dst_height,
...
void ConvolutionDecimation::do_vertical_decimation(uint16_t *dst_ptr, uint16_t *src_ptr,
                    uint dst_width, uint dst_height,
                    uint dst_stride, uint src_stride,uint i_,uint max_thread_) {
	//
   int fircoeff[7]={-3026,64,10758,17176,10758,64,-3026}; 
